...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE "quoter"'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;--
...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE "notauto_pk"'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;--
...
CREATE TABLE "quoter" (
  ...
  "description" varchar2(128) NOT NULL,
  CONSTRAINT "quoter_PK" PRIMARY KEY ("name") ENABLE
);
